...
<div class="wrapper rounded bg-white">
    <div class="h3">Member Add</div><hr>
	<center><img src="images/member.jpg" alt="Image" class="img-fluid" width="150" height="150"/></center><br>
        <div class="form">
            <form method="post" action="/addmember" enctype="multipart/form-data" class="form-control">
            @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3"><label>Category</label> 
                        <select id="sub" name="category" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3"> <label>Research</label> 
                        <select id="sub" name="researchTitle" required>
                            <option value="" selected hidden>Choose Research</option>
                ...
                <div class="row">
                   <div class="my-md-2 my-3"><label>Educational Background</label> 
                        <textarea rows="5" cols="74" name="educationional_background" type="text"></textarea>
                   </div>
                </div>
                <div class="row">
                   <div class="my-md-2 my-3"><label>Professional Background</label> 
                        <textarea rows="5" cols="74" name="professional_background" type="text"></textarea>
                   </div>
                </div>
                <div class="row">
