    ...
    <section>
      <div class="container-fluid d-flex">
        <div class="sidebar bg-dark" id="side_nav">
            <div class="header-box d-flex justify-content-between px-xl-4 p-2">
            ...
            <ul class="list-unstyled px-xl-4 py-3">
                ...
                <li><a href="indexTable.html" class="armanSidebarMenuText active">Index</a></li>
                <li><a href="showDetails.html" class="armanSidebarMenuText">Show</a></li>
                <li><a href="editForm.html" class="armanSidebarMenuText">Edit</a></li>
            </ul>
        </div>
                  ...
                  <tbody>
                    @foreach ($all_data as $all_data)
                      <tr>
                        <td>{{ $all_data->name }}</td>
                        <td>
                          <img src="{{ $all_data->image }}" style="width:500px;height:500px;background: yellow;" alt="Image">
                        </td>
                        <td class="text-center">
                          <a href="{{ url('/show',$all_data->id) }}" class="btn btn-warning fw-bold mb-1"><i class="bi bi-eye-fill"></i> Show</a>
                          <a href="{{ url('/edit',$all_data->id) }}" class="btn btn-primary fw-bold mb-1"><i class="bi bi-pencil-fill"></i> Edit</a>
                          <a href="{{ url('/delete',$all_data->id) }}" class="btn btn-danger fw-bold mb-1"><i class="bi bi-trash3-fill"></i> Delete</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
