      ...
      <div class="container-fluid d-flex">
        <div class="sidebar bg-dark" id="side_nav">
            ...
            <ul class="list-unstyled px-xl-4 py-3">
                <li><a href="createForm.html" class="armanSidebarMenuText active">Create</a></li>
                    ...
                    <form action="{{ url('/store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mb-3 px-2">
                                <input type="text/email/password" name="name" placeholder="Name" class="form-control" required>
                            </div>

                            <!-- textarea type -->
                            <div class="col-12 mb-3 px-2">
                                <textarea name="description"  class="form-control" cols="30" rows="3" placeholder="Description" required></textarea>
                            </div>
